...
void Planet::pillagePlanet(int* rX, int* rR, int* rDi, int* rD, int* rL, int* rPl, int* rU, int* rP, int* rNW)
{
	for (i = 0; i <= 8; i++)
	{
		...
		case 0:
			...
			{
				*rX = getIRange(10, 4500) * PV_EKS0;
			}

			else if ((pEKS >= 1.000f) && (pEKS <= 1.999f))
			{
				*rX = getIRange(50, 6590) * PV_EKS1;
			}

			else if ((pEKS >= 2.000f) && (pEKS <= 2.999f))
			{
				*rX = getIRange(86, 7820) * PV_EKS2;
			}

			else if ((pEKS >= 3.000f) && (pEKS <= 3.999f))
			{
				*rX = getIRange(110, 8950) * PV_EKS3;
			}

			else if ((pEKS >= 4.000f) && (pEKS <= 4.999f))
			{
				*rX = getIRange(136, 9785) * PV_EKS4;
			}

			else if ((pEKS >= 5.000f))
			{
				*rX = getIRange(180, 14580) * PV_EKS5;
			}
		...
		case 1:
			if ((pEKS >= 0.000f) && (pEKS <= 0.999f))
			{
				*rR = getIRange(10, 4500) * PV_EKS0;
			}

			else if ((pEKS >= 1.000f) && (pEKS <= 1.999f))
			{
				*rR = getIRange(50, 6590) * PV_EKS1;
			}

			else if ((pEKS >= 2.000f) && (pEKS <= 2.999f))
			{
				*rR = getIRange(86, 7820) * PV_EKS2;
			}

			else if ((pEKS >= 3.000f) && (pEKS <= 3.999f))
			{
				*rR = getIRange(110, 8950) * PV_EKS3;
			}

			else if ((pEKS >= 4.000f) && (pEKS <= 4.999f))
			{
				*rR = getIRange(136, 9785) * PV_EKS4;
			}

			else if ((pEKS >= 5.000f))
			{
				*rR = getIRange(180, 14580) * PV_EKS5;
			}
		...
		case 2:
			if ((pEKS >= 0.000f) && (pEKS <= 0.999f))
			{
				*rDi = getIRange(10,4500) * PV_EKS0;
			}

			else if ((pEKS >= 1.000f) && (pEKS <= 1.999f))
			{
				*rDi = getIRange(50, 6590) * PV_EKS1;
			}

			else if ((pEKS >= 2.000f) && (pEKS <= 2.999f))
			{
				*rDi = getIRange(86, 7820) * PV_EKS2;
			}

			else if ((pEKS >= 3.000f) && (pEKS <= 3.999f))
			{
				*rDi = getIRange(110, 8950) * PV_EKS3;
			}

			else if ((pEKS >= 4.000f) && (pEKS <= 4.999f))
			{
				*rDi = getIRange(136, 9785) * PV_EKS4;
			}

			else if ((pEKS >= 5.000f))
			{
				*rDi = getIRange(180, 14580) * PV_EKS5;
			}
		...
		case 3:
			if ((pEKS >= 0.000f) && (pEKS <= 0.999f))
			{
				*rD = getIRange(10,4500) * PV_EKS0;
			}

			else if ((pEKS >= 1.000f) && (pEKS <= 1.999f))
			{
				*rD = getIRange(50, 6590) * PV_EKS1;
			}

			else if ((pEKS >= 2.000f) && (pEKS <= 2.999f))
			{
				*rD = getIRange(86, 7820) * PV_EKS2;
			}

			else if ((pEKS >= 3.000f) && (pEKS <= 3.999f))
			{
				*rD = getIRange(110, 8950) * PV_EKS3;
			}

			else if ((pEKS >= 4.000f) && (pEKS <= 4.999f))
			{
				*rD = getIRange(136, 9785) * PV_EKS4;
			}

			else if ((pEKS >= 5.000f))
			{
				*rD = getIRange(180, 14580) * PV_EKS5;
			}
		...
		case 4:
			if ((pEKS >= 0.000f) && (pEKS <= 0.999f))
			{
				*rL = getIRange(10,4500) * PV_EKS0;
			}

			else if ((pEKS >= 1.000f) && (pEKS <= 1.999f))
			{
				*rL = getIRange(50, 6590) * PV_EKS1;
			}

			else if ((pEKS >= 2.000f) && (pEKS <= 2.999f))
			{
				*rL = getIRange(86, 7820) * PV_EKS2;
			}

			else if ((pEKS >= 3.000f) && (pEKS <= 3.999f))
			{
				*rL = getIRange(110, 8950) * PV_EKS3;
			}

			else if ((pEKS >= 4.000f) && (pEKS <= 4.999f))
			{
				*rL = getIRange(136, 9785) * PV_EKS4;
			}

			else if ((pEKS >= 5.000f))
			{
				*rL = getIRange(180, 14580) * PV_EKS5;
			}
		...
		case 5:
			if ((pEKS >= 0.000f) && (pEKS <= 0.999f))
			{
				*rPl = getIRange(10,4500) * PV_EKS0;
			}

			else if ((pEKS >= 1.000f) && (pEKS <= 1.999f))
			{
				*rPl = getIRange(50, 6590) * PV_EKS1;
			}

			else if ((pEKS >= 2.000f) && (pEKS <= 2.999f))
			{
				*rPl = getIRange(86, 7820) * PV_EKS2;
			}

			else if ((pEKS >= 3.000f) && (pEKS <= 3.999f))
			{
				*rPl = getIRange(110, 8950) * PV_EKS3;
			}

			else if ((pEKS >= 4.000f) && (pEKS <= 4.999f))
			{
				*rPl = getIRange(136, 9785) * PV_EKS4;
			}

			else if ((pEKS >= 5.000f))
			{
				*rPl = getIRange(180, 14580) * PV_EKS5;
			}
		...
		case 6:
			if ((pEKS >= 0.000f) && (pEKS <= 0.999f))
			{
				*rU = getIRange(10,4500) * PV_EKS0;
			}

			else if ((pEKS >= 1.000f) && (pEKS <= 1.999f))
			{
				*rU = getIRange(50, 6590) * PV_EKS1;
			}

			else if ((pEKS >= 2.000f) && (pEKS <= 2.999f))
			{
				*rU = getIRange(86, 7820) * PV_EKS2;
			}

			else if ((pEKS >= 3.000f) && (pEKS <= 3.999f))
			{
				*rU = getIRange(110, 8950) * PV_EKS3;
			}

			else if ((pEKS >= 4.000f) && (pEKS <= 4.999f))
			{
				*rU = getIRange(136, 9785) * PV_EKS4;
			}

			else if ((pEKS >= 5.000f))
			{
				*rU = getIRange(180, 14580) * PV_EKS5;
			}
		...
		case 7:
			if ((pEKS >= 0.000f) && (pEKS <= 0.999f))
			{
				*rP = getIRange(10,4500) * PV_EKS0;
			}

			else if ((pEKS >= 1.000f) && (pEKS <= 1.999f))
			{
				*rP = getIRange(50, 6590) * PV_EKS1;
			}

			else if ((pEKS >= 2.000f) && (pEKS <= 2.999f))
			{
				*rP = getIRange(86, 7820) * PV_EKS2;
			}

			else if ((pEKS >= 3.000f) && (pEKS <= 3.999f))
			{
				*rP = getIRange(110, 8950) * PV_EKS3;
			}

			else if ((pEKS >= 4.000f) && (pEKS <= 4.999f))
			{
				*rP = getIRange(136, 9785) * PV_EKS4;
			}

			else if ((pEKS >= 5.000f))
			{
				*rP = getIRange(180, 14580) * PV_EKS5;
			}
		...
		case 8:
			if ((pEKS >= 0.000f) && (pEKS <= 0.999f))
			{
				*rNW = getIRange(10,4500) * PV_EKS0;
			}

			else if ((pEKS >= 1.000f) && (pEKS <= 1.999f))
			{
				*rNW = getIRange(50, 6590) * PV_EKS1;
			}

			else if ((pEKS >= 2.000f) && (pEKS <= 2.999f))
			{
				*rNW = getIRange(86, 7820) * PV_EKS2;
			}

			else if ((pEKS >= 3.000f) && (pEKS <= 3.999f))
			{
				*rNW = getIRange(110, 8950) * PV_EKS3;
			}

			else if ((pEKS >= 4.000f) && (pEKS <= 4.999f))
			{
				*rNW = getIRange(136, 9785) * PV_EKS4;
			}

			else if ((pEKS >= 5.000f))
			{
				*rNW = getIRange(180, 14580) * PV_EKS5;
			}
...
{
	beltRand = getIRange(0, 10);

	if (beltRand != 0)
	{
		for (i = 1; i <= beltRand; i++)
		{
			ramount = getIRange(3, 15); //External value tag: int range
			size = ((ramount * getFRange(1000.0f, 50000.00f) * 46) / 2); //External value tag: float range
