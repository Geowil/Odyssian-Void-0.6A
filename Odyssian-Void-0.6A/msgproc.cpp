...
int msgProc::pCMenu1()
{
	...
	{
		ds_mp.rData("Ship","select from",i);
...
bool msgProc::bHail1(string affiliation, string race, int affinity)
{
	...
	hSRate = getIRange(1, 300);

	if (affinity >= 26)
	{
		if (hSRate * 10 / 5 < 360)
		{
			cout << mRMessage(getIRange(47, 50)) << endl;
			return true;
		}

		else
		{
			cout << mRMessage(getIRange(57, 60)) << endl;
			return false;
		}
	}
	...
	else if ((affinity < 25) && (affinity > -22))
	{
		if (hSRate * 10 / 5 < 360)
		{
			cout << mRMessage(getIRange(67, 70)) << endl;
			return true;
		}

		else
		{
			cout << mRMessage(getIRange(77, 80)) << endl;
			return false;
		}
	}
	...
	else if (affinity <= -23)
	{
		if (hSRate * 10 / 5 < 360)
		{
			cout << mRMessage(getIRange(87, 90)) << endl;
			return true;
		}

		else
		{
			cout << mRMessage(getIRange(97, 100)) << endl;
			return false;
		}
	}
	/*}
...
bool msgProc::bHail3(int affinity, int pChoice, string race, string affil)
{
	...
	case 1:
		if (affinity >= 26)
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(107, 109)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(117, 118)) << endl;
				return false;
			}
		}
		...
		else if ((affinity < 25) && (affinity > -22))
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(127, 128)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(137, 139)) << endl;
				return false;
			}
		}
		...
		else if (affinity <= -23)
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(147, 148)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(157, 159)) << endl;
				return false;
			}
		}
	...
	case 2:
		if (affinity >= 26)
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(167, 169)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(177, 178)) << endl;
				return false;
			}
		}
		...
		else if ((affinity < 25) && (affinity > -22))
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(187, 188)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(197, 199)) << endl;
				return false;
			}
		}
		...
		else if (affinity <= -23)
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(207, 208)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(217, 219)) << endl;
				return false;
			}
		}
	...
	case 3:
		if (affinity >= 26)
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(227, 229)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(237, 238)) << endl;
				return false;
			}
		}
		...
		else if ((affinity < 25) && (affinity > -22))
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(247, 248)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(257, 259)) << endl;
				return false;
			}
		}
		...
		else if (affinity <= -23)
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(267, 268)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(277, 279)) << endl;
				return false;
			}
		}
	...
	case 4:
		if (affinity >= 26)
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(287, 289)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(297, 298)) << endl;
				return false;
			}
		}
		...
		else if ((affinity < 25) && (affinity > -22))
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(307, 308)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(317, 319)) << endl;
				return false;
			}
		}
		...
		else if (affinity <= -23)
		{
			if (hSRate * 10 / 5 < 360)
			{
				cout << mRMessage(getIRange(327, 328)) << endl;
				return true;
			}

			else
			{
				cout << mRMessage(getIRange(337, 339)) << endl;
				return false;
			}
		}
	...
	case 5:
		if (affinity >= 26)
		{
			cout << mRMessage(getIRange(347, 351)) << endl;
			return true;
		}

		else if ((affinity < 25) && (affinity > -22))
		{
			cout << mRMessage(getIRange(367, 371)) << endl;
			return true;
		}

		else if (affinity <= -23)
		{
			cout << mRMessage(getIRange(397, 401)) << endl;
			return true;
		}
...
//Station Menus
int msgProc::sMenu(Station& stat)
{
	...
	{
		//pChoice = checkMInput(pChoice,1,12,1);
	}
...
int msgProc::sMCMenu()
{
	...
	cout << "6) Commandship" << endl;
	cout << "7) Mothership" << endl;
	cout << "8) Titan" << endl;
	...
	pChoice = checkMInput(pChoice,1,10,10, false);
...
int msgProc::sMTMenu()
{
	...
	cout << "5) Type 4" << endl;
	cout << "6) Type 5" << endl;
	cout << "7) Back to station menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,7,7, false);

	mCScreen(true);
	return pChoice;
}

int msgProc::sMDSMenu()
{
	cout << mRMessage(2027) << endl << endl;
	...
	pChoice = checkMInput(pChoice,1,4,4, false);
...
//Primary Market Menus

//Equipment Menu
int msgProc::sMEMLoop()
{
	cout << mRMessage(1) << endl << endl;
	cout << "1) Ammunition" << endl;
	cout << "2) Drones" << endl;
	cout << "3) Mining" << endl;
	cout << "4) Modules" << endl;
	cout << "5) Planetary Equipment" << endl;
	cout << "6) Rigs" << endl;
	cout << "7) Ship Equipment" << endl;
	cout << "8) Weapons" << endl;
	cout << "9) Return to Market Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	//pChoice = checkMInput(pChoice,1,9,9);
...
//Misc Menu
int msgProc::sMMMLoop()
{
	cout << mRMessage(1) << endl << endl;
	cout << "1) Ores" << endl;
	cout << "2) Resources" << endl;
	cout << "3) Station Construction Packs" << endl;
	cout << "4) Return to Market Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	//pChoice = checkMInput(pChoice,1,4,4);
...
//Ship Menu
int msgProc::sMSMLoop()
{
	pChoice = sMCMenu();

	//pChoice = checkMInput(pChoice,1,11,10);
...
//Skills Menu
int msgProc::sMSKMLoop()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Battle Skills" << endl;
	cout << "2) Cartography Skills" << endl;
	cout << "3) Mining Skills" << endl;
	cout << "4) Planetary Skills" << endl;
	cout << "5) Production Skills" << endl;
	cout << "6) Reprocessing Skills" << endl;
	cout << "7) Ship Skills" << endl;
	cout << "8) Station Skills" << endl;
	cout << "9) Trade Skills" << endl;
	cout << "10) Training Skills" << endl;
	cout << "11) Weapon Skills" << endl;
	cout << "12) Return to Market Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,12,12,false);
...
//Secondary Market Menus

//Equipment Menus

//Ammunition Menu
int msgProc::sMEMAmmo()
{
	cout << mRMessage(1) << endl << endl;
	cout << "1) Missiles" << endl;
	cout << "2) Ammunition Material Blocks" << endl;
	cout << "3) Return to Equipment Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	//pChoice = checkMInput(pChoice,1,3,3);
...
//Drone Menu
int msgProc::sMEMDrones()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Electronic Warfare Drones" << endl;
	cout << "2) EWCM Drones" << endl;
	cout << "3) Military Drones" << endl;
	cout << "4) Mining Drones" << endl;
	cout << "5) Repair Drones" << endl;
	cout << "6) Return to Equipment Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	//pChoice = checkMInput(pChoice,1,6,6);
...
//Mining Menu
int msgProc::sMEMMining()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Attunement Crystals" << endl;
	cout << "2) Mining Lasers" << endl;
	cout << "3) Strip Miners" << endl;
	cout << "4) Return to Equipment Menu" << endl;
...
//Modules Menu
int msgProc::sMEMMods()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Active Modules" << endl;
	cout << "2) Passive Modules" << endl;
	cout << "3) Return to Equipment Menu" << endl;
...
//Planetary Equipment Menu
int msgProc::sMEMPEquip()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Colonization Prefabs" << endl;
	cout << "2) Planetary Administration and Colonization Tools (PACTs)" << endl;
	cout << "3) Planetary Defenses" << endl;
	cout << "4) Planetary Shields" << endl;
	cout << "5) Return to Equipment Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,5,5, false);
...
//Rigs Menu
int msgProc::sMEMRigs()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Low Slot Rigs" << endl;
	cout << "2) Mid Slot Rigs" << endl;
	cout << "3) High Slot Rigs" << endl;
	cout << "4) Return to Equipment Menu" << endl;
...
//Ship Equipment Menu
int msgProc::sMEMSEquip()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Capacitor Systems" << endl;
	cout << "2) CPU Cores" << endl;
	cout << "3) Engine Systems" << endl;
	cout << "4) Memory Cores" << endl;
	cout << "5) Power Systems" << endl;
	cout << "6) Warp Drive Systems" << endl;
	cout << "7) Weapon Targeting Systems" << endl;
	cout << "8) Return to Equipment Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,8,8, false);
...
//Weapons Menu
int msgProc::sMEMWeaps()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Bombs" << endl;
	cout << "2) Heavy Weapons" << endl;
	cout << "3) Lasers Banks" << endl;
	cout << "4) Mining Lasers" << endl;
	cout << "5) Missile Launchers" << endl;
	cout << "6) Railguns" << endl;
	cout << "7) Return to Equipment Menu" << endl;
...
int msgProc::sMMMOres()
{
	...
	cout << "3) Methyx" << endl;
	cout << "4) Pyrax" << endl;
	cout << "5) Return to Misc Menu" << endl;
...
int msgProc::sMMMRes()
{
	...
	cout << "2) Draconic" << endl;
	cout << "3) Lithium" << endl;
	cout << "4) Nuclear Waste" << endl;
	cout << "5) Platinum" << endl;
	cout << "6) Plutonium" << endl;
	cout << "7) Rubies" << endl;
	cout << "8) Uranium" << endl;
	cout << "9) Return to Misc Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,9,9, false);

	mCScreen(true);
	return pChoice;
}

//Station Construction Kit Menu
int msgProc::sMMMStat()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) General Stations" << endl;
	cout << "2) Mining Stations" << endl;
	cout << "3) Power Stations" << endl;
	cout << "4) Production Stations" << endl;
	cout << "5) Return to Misc Menu" << endl;
...
//Battle Skills Menu
int msgProc::sMSKMBSkills()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Planetary Battle Skills" << endl;
	cout << "2) Ship Battle Skills" << endl;
	cout << "3) Return to Skill Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,3,3,false);

	mCScreen(true);
	return pChoice;
}

//Chartography Skills Menu
int msgProc::sMSKMCSkills()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 2);
...
//Mining Skills Menu
int msgProc::sMSKMMSkills()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 3);
...
//Planetary Skills Menu
int msgProc::sMSKMPLSkills()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Administration Skills" << endl;
	cout << "2) Colonization Skills" << endl;
	cout << "3) Return to Skill Menu" << endl;
...
//Production Skills Menu
int msgProc::sMSKMPRSkills()
{
	return 0;
}

//Reprocessing Skills Menu
int msgProc::sMSKMMCRSkill()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 6);
...
//Ship Skills Menu
int msgProc::sMSKMSSkills()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Cargo Skills" << endl;
	cout << "2) CPU Skills" << endl;
	cout << "3) Engine Skills" << endl;
	cout << "4) Memory Skills" << endl;
	cout << "5) Module Skills" << endl;
	cout << "6) Power System Skills" << endl;
	cout << "7) Rig Skills" << endl;
	cout << "8) Shield Skills" << endl;
	cout << "9) Weapon System Skills" << endl;
	cout << "10) Return to Skill Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,11,11,false);
...
//Station Skills Menu
int msgProc::sMSKMSTSkills()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 16);
...
//Trade Skills Menu
int msgProc::sMSKMTSkills()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 22);
...
int msgProc::sMSKMTRSkills()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 17);
...
//Weapon Skills Menu
int msgProc::sMSKMWSkills()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Bomb Skills" << endl;
	cout << "2) Heavy Weapon Skills" << endl;
	cout << "3) Laser Skills" << endl;
	cout << "4) Missile Turret Skills" << endl;
	cout << "5) Railgun Skills" << endl;
	cout << "6) Return to Skill Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,6,6,false);
...
int msgProc::sMEMAMissiles()
{
	...
	pVRange = getIPair(gv::wIDS, 2, cCode - 1);
	...
	pChoice = checkMInput(pChoice, pVRange.first, pVRange.second,0,true);
	
	mCScreen(true);
	return pChoice;
}

//Ammo- Material Blocks Menu
int msgProc::sMEMARMBlocks()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Antimatter Material Blocks" << endl;
	cout << "2) Titanium Material Blocks" << endl;
	cout << "3) Tungsten " << endl;
	cout << "4) Return to Ammunition Menu" << endl;
...
//Drones- EW Drone Menu
int msgProc::sMEMDEWDrones()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Cloak Jammers" << endl;
	cout << "2) Hackers" << endl;
	cout << "3) Sensor Jammers" << endl;
	cout << "4) Targeting Jammers" << endl;
	cout << "5) Warp Scramblers" << endl;
	cout << "6) Return to Drone Menu" << endl;
...
//Drone- EWMC Drones Menu
int msgProc::sMEMDECDrones()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Cloak Boosters" << endl;
	cout << "2) EDDs" << endl;
	cout << "3) Sensor Modulators" << endl;
	cout << "4) Targeting Repeaters" << endl;
	cout << "5) Warp Stabalizers" << endl;
	cout << "6) Return to Drone Menu" << endl;
...
//Drone- Military Drones Menu
int msgProc::sMEMDMDrones()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Recon Drones" << endl;
	cout << "2) Scout Drones" << endl;
	cout << "3) War Drones" << endl;
	cout << "4) Tank Drones" << endl;
...
//Drone- Mining Drones Menu
int msgProc::sMEMDMining()
{
	pChoice2 = sMDSMenu();

	//Figure out how to get specific drone size as selected above in pChoice 2 and use this in returning data form the db
}

//Drone- Repair Drones Menu
int msgProc::sMEMDRDrones()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Armor Repair Drones" << endl;
	cout << "2) Hull Repair Drones" << endl;
	cout << "3) Versatile Repair Drones" << endl;
	cout << "4) Return to Drone Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	//pChoice = checkMInput(pChoice,1,11,11);
...
//Mining- Attunement Crystals Menu
int msgProc::sMEMMACrystals()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Carboid Crystals" << endl;
	cout << "2) Cesogyn Crystals" << endl;
	cout << "3) Methyx Crystals" << endl;
	cout << "4) Pyrax Crystals" << endl;
	cout << "5) Return to Mining Equipment Menu" << endl;
...
//Mining- Mining Lasers Menu
int msgProc::sMEMMLasers()
{
	return 0;
}

//Mining- Strip Miners Menu
int msgProc::sMEMMStrippers()
{
	return 0;
}

//Modules- Active Modules Menu
int msgProc::sMEMMDActive()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Afterburners" << endl;
	cout << "2) Electronic Warfare Modules" << endl;
	cout << "3) EWCM Modules" << endl;
	cout << "4) Repair Booms" << endl;
	cout << "5) Scanner Modules" << endl;
	cout << "6) Shield Hardener Modules" << endl;
	cout << "7) Return to Modules Menu" << endl;
...
//Modules- Passive Modules Menu
int msgProc::sMEMMDPassive()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Ship Enhancements" << endl;	
	cout << "2) Return to Modules Menu" << endl;

	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,2,2,false);

	mCScreen(true);
	return pChoice;
}

int msgProc::sMEMPECPrefabs()
{
	return 0;
}

int msgProc::sMEMPEOWPlatforms()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Heavy Weapon Platforms" << endl;
	cout << "2) Laser Weapon Platforms" << endl;
	cout << "3) Missile Weapon Platforms" << endl;
	cout << "4) Railgun Weapon Platforms" << endl;
	cout << "5) Return to Planetary Equipment Menu" << endl;
...
int msgProc::sMEMPEPACT()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Management Tools" << endl;
	cout << "2) Terraforming Tools" << endl;
	cout << "3) Return to Planetary Equipment Menu" << endl;
...
int msgProc::sMEMPEPShields(int type)
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::psIDS, type);
...
int msgProc::sMEMRLSlot()
{
	return 0;
}

int msgProc::sMEMRMSlot()
{
	return 0;
}

int msgProc::sMEMRHSlot()
{
	return 0;
}

int msgProc::sMEMSECSystems()
{
	return 0;
}

int msgProc::sMEMSECCores()
{
	return 0;
}

int msgProc::sMEMSEESystems()
{
	return 0;	
}

int msgProc::sMEMSEMCores()
{
	return 0;
}

int msgProc::sMEMSEPSystem()
{
	return 0;
}

int msgProc::sMEMSEWDSystem()
{
	return 0;
}

int msgProc::sMEMSEWTSystem()
{
	return 0;
}

int msgProc::sMEMWLasers()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::wIDS, 0, cCode - 1);
...
int msgProc::sMEMWMissiles()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::wIDS, 1, cCode - 1);
...
int msgProc::sMEMWBombs()
{
	...
	pChoice = checkMInput(pChoice, pVRange.first, pVRange.second,2,true);
		
	return pChoice;
}

int msgProc::sMEMWRail()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::wIDS, 3, cCode - 1);
	...
	pChoice = checkMInput(pChoice, pVRange.first, pVRange.second,3,true);
		
	return pChoice;
}

int msgProc::sMEMWHeavy()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::wIDS, 4, cCode - 1);
	...
	pChoice = checkMInput(pChoice, pVRange.first, pVRange.second,4,true);
		
	return pChoice;
}

int msgProc::sMEMWMLasers()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;
...
int msgProc::sMMMOCarboid()
{
	return 0;
}

int msgProc::sMMMOCesogyn()
{
	return 0;
}

int msgProc::sMMMOMethyx()
{
	return 0;
}

int msgProc::sMMMOPyrax()
{
	return 0;
}

int msgProc::sMSKMBSBSkills()
{
	cout << mRMessage(1) << endl << endl;

	pVRange = getIPair(gv::skIDS, 0);
...
int msgProc::sMSKMBPBSkills()
{
	cout << mRMessage(1) << endl << endl;

	pVRange = getIPair(gv::skIDS, 1);
...
int msgProc::sMSKMPLSASkills()
{
	cout << mRMessage(1) << endl << endl;

	pVRange = getIPair(gv::skIDS, 4);
...
int msgProc::sMSKMPLSCSkills()
{
	cout << mRMessage(1) << endl << endl;

	pVRange = getIPair(gv::skIDS, 5);
...
int msgProc::sMSKMSSCASkills()
{
	
}

int msgProc::sMSKMSSCPSkills()
{
	
}

int msgProc::sMSKMSSESkills()
{
	
}

int msgProc::sMSKMSSMESkills()
{
	
}

int msgProc::sMSKMSSMOSkills()
{
	
}

int msgProc::sMSKMSSPSSkills()
{
	
}

int msgProc::sMSKMSSRSkills()
{
	
}

int msgProc::sMSKMSSSSkills()
{
	
}

int msgProc::sMSKMSSWSSkills()
{
	
}

int msgProc::sMSKMWSBSkills()
{
	cout << mRMessage(1) << endl << endl;
...
int msgProc::sMSKMWSHSkills()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 18);
...
int msgProc::sMSKMWSLSkills()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 19);
...
int msgProc::sMSKMWSMLSkills()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 20);
...
int msgProc::sMSKMWSRSkills()
{
	cout << mRMessage(1) << endl << endl;
	
	pVRange = getIPair(gv::skIDS, 21);
...
int msgProc::sMEMAMRMBA()
{
	return 0;
}

int msgProc::sMEMAMRMBTi()
{
	return 0;
}

int msgProc::sMEMAMRMBTu()
{
	return 0;
}

int msgProc::sMEMDEWDCJammers()
{
	return 0;
}

int msgProc::sMEMDEWDHackers()
{
	return 0;
}

int msgProc::sMEMDEWDSJammers()
{
	return 0;
}

int msgProc::sMEMDEWDTJammers()
{
	return 0;
}

int msgProc::sMEMDEWDWScrams()
{
	return 0;
}

int msgProc::sMEMDECDCBoosters()
{
	return 0;
}

int msgProc::sMEMDECDEDDrones()
{
	return 0;
}

int msgProc::sMEMDECDSModulators()
{
	return 0;
}

int msgProc::sMEMDECDTRepeaters()
{
	return 0;
}

int msgProc::sMEMDECDWStabalizers()
{
	return 0;
}

int msgProc::sMEMDMDRecon()
{
	return 0;
}

int msgProc::sMEMDMDScouts()
{
	return 0;
}

int msgProc::sMEMDMDWar()
{
	return 0;
}

int msgProc::sMEMDMTanks()
{
	return 0;
}

int msgProc::sMEMDRDArmor()
{
	return 0;
}

int msgProc::sMEMDRDHull()
{
	return 0;
}

int msgProc::sMEMDRDVersitile()
{
	return 0;
}

int msgProc::sMEMMACCarboid()
{

}

int msgProc::sMEMMACCesogyn()
{

}

int msgProc::sMEMMACMethyx()
{

}

int msgProc::sMEMMACPyrax()
{

}

int msgProc::sMEMMDAABurners()
{
	return 0;
}

int msgProc::sMEMMDAEWarfare()
{
	return 0;
}

int msgProc::sMEMMDAEWCM()
{
	return 0;
}

int msgProc::sMEMMDARBooms()
{
	return 0;
}

int msgProc::sMEMMDAScanners()
{
	return 0;
}

int msgProc::sMEMMDASHardeners()
{
	return 0;
}

int msgProc::sMEMMDPSEnhancements()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Capacitor Enhancements" << endl;
	cout << "2) Cargo Enhancements" << endl;
	cout << "3) CPU Enhancements" << endl;
	cout << "4) Engine Enhancements" << endl;
	cout << "5) Memory Enhancements" <<  endl;
	cout << "6) Power System Enhancements" << endl;
	cout << "7) Shield System Enhancements" << endl;
	cout << "8) Weapon Systems Enhancements" << endl;
	cout << "9) Return to Module Menu" << endl;
...
int msgProc::sMEMPEOWPHeavy()
{
	return 0;
}

int msgProc::sMEMPEOWPLaser()
{
	return 0;
}

int msgProc::sMEMPEOWPMissile()
{
	return 0;
}

int msgProc::sMEMPEOWPRail()
{
	return 0;
}

int msgProc::sMEMPEPACTMTools()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Orbital Supply Depots" << endl;
	cout << "11) Return to PACTs Equipment Menu" << endl;
...
int msgProc::sMEMPEPACTTTools()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Atmospheric Gas Generators" << endl;
	cout << "2) Atmospheric Gas Scrubbers" << endl;
	cout << "3) Baterial Decontaminants" << endl;
	cout << "4) Fungal Decontaminants" << endl;
	cout << "5) Radiation Scrubbers" <<  endl;
	cout << "6) Ship Skills" << endl;
	cout << "7) Viral Decontaminants" << endl;
	cout << "8) Return to PACTs Equipment Menu" << endl;
...
int msgProc::sMEMDMDWBomb()
{
	return 0;
}

int msgProc::sMEMDMDWHeavy()
{
	return 0;
}

int msgProc::sMEMDMDWLaser()
{
	return 0;
}

int msgProc::sMEMDMDWMissile()
{
	return 0;
}

int msgProc::sMEMDMDWRail()
{
	return 0;
}

int msgProc::sMEMMDAEWJammers()
{
	return 0;
}

int msgProc::sMEMMDAEWHackers()
{
	return 0;
}

int msgProc::sMEMMDAEWSJammers()
{
	return 0;
}

int msgProc::sMEMMDAEWTJammers()
{
	return 0;
}

int msgProc::sMEMMDAEWWScrams()
{
	return 0;
}

int msgProc::sMEMMDAEWCMCBoosters()
{
	return 0;
}

int msgProc::sMEMMDAEWCMEDModules()
{
	return 0;
}

int msgProc::sMEMMDAEWCMSModulators()
{
	return 0;
}

int msgProc::sMEMMDAEWCMTRepeaters()
{
	return 0;
}

int msgProc::sMEMMDAEWCMWStabalizers()
{
	return 0;
}

int msgProc::sMEMMDARBArmor()
{
	return 0;
}

int msgProc::sMEMMDARBHull()
{
	return 0;
}

int msgProc::sMEMMDARBVersatile()
{
	return 0;
}

int msgProc::sMEMMDASCargo()
{
	return 0;
}

int msgProc::sMEMMDASMineral()
{
	return 0;
}

int msgProc::sMEMMDPSECap()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Capacitor Capacity Enhancements" << endl;
	cout << "2) Capacitor Efficiency Enhancements" << endl;
	cout << "3) Capacitor Recharge Enhancements" << endl;
	cout << "4) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSECargo()
{
	return 0;
}

int msgProc::sMEMMDPSECPU()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) CPU Efficiency Enhancements" << endl;
	cout << "2) CPU Power Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSEEngine()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Engine Sub-Warp Enhancements" << endl;
	cout << "2) Engine Warp Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSEMemory()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Memory Capacity Enhancements" << endl;
	cout << "2) Memory Efficiency Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSEPSystem()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Power System Capacity Enhancements" << endl;
	cout << "2) Power System Efficiency Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSESSystem()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Shield System Capacity Enhancements" << endl;
	cout << "2) Shield System Recharge Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSEWSystem()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Weapons Systems Efficiency Enhancements" << endl;
	cout << "2) Weapons Systems Targeting Expansions" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMPEPACTMTOSD()
{
	return 0;
}

int msgProc::sMEMMDPSECCE()
{
	return 0;
}

int msgProc::sMEMMDPSECEE()
{
	return 0;
}

int msgProc::sMEMMDPSECRE()
{
	return 0;
}

int msgProc::sMEMMDPSECPUEE()
{
	return 0;
}

int msgProc::sMEMMDPSECPUPE()
{
	return 0;
}

int msgProc::sMEMMDPSEESE()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Sub-Warp Navigation Enhancements" << endl;
	cout << "2) Sub-Warp Speed Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSEEWE()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Warp Field Enhancements" << endl;
	cout << "2) Warp Power Consumption Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSEMCE()
{
	return 0;
}

int msgProc::sMEMMDPSEMEE()
{
	return 0;
}

int msgProc::sMEMMDPSEPSCE()
{
	return 0;
}

int msgProc::sMEMMDPSEPSEE()
{
	return 0;
}

int msgProc::sMEMMDPSESSCE()
{
	return 0;
}

int msgProc::sMEMMDPSESSRE()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Recharge Power Consumption Enhancements" << endl;
	cout << "2) Recharge Time Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSEWSEE()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Power Consumption Enhancements" << endl;
	cout << "2) Targeting Time Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSEWSTE()
{
	
}

int msgProc::sMEMMDPSEESENE()
{
	return 0;
}

int msgProc::sMEMMDPSEESESE()
{
	return 0;
}

int msgProc::sMEMMDPSEEWEFE()
{
	cout << mRMessage(1) << endl << endl;

	cout << "1) Warp Conduit Stabilization" << endl;
	cout << "2) Warp Field Stabilization Enhancements" << endl;
	cout << "3) Return to Market Menu" << endl;
...
int msgProc::sMEMMDPSEEWEPCE()
{
	return 0;
}

int msgProc::sMEMMDPSESSREPCE()
{
	return 0;
}

int msgProc::sMEMMDPSESSRETE()
{
	return 0;
}

int msgProc::sMEMMDPSEWSEEPC()
{
	return 0;
}

int msgProc::sMEMMDPSEWSEETE()
{
	return 0;
}

int msgProc::sMEMMDPSEEWEFECSE()
{
	return 0;
}

int msgProc::sMEMMDPSEEWEFEFSE()
{
	return 0;
}
...
int msgProc::sMSClass()
{
	...
	pChoice = checkMInput(pChoice,1,10);

	return pChoice;
}

int msgProc::checkMInput(int pChoice, int low, int high, int def, bool bIsZero)
{
	if (pChoice < low || pChoice > high)
	{
		if ((pChoice == 0) && (!bIsZero))
		{
			cout << mRMessage(5) << endl;
			pChoice = def;
		}
...
void msgProc::pBTPMenu(int lastOption)
{
	cout << lastOption+1 << ") Back to Previous Menu" << endl;
}

int msgProc::sMSMFrigs()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange =  getIPair(gv::sIDS, 0);
...
int msgProc::sMSMDests()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::sIDS, 1);
...
int msgProc::sMSMCruis()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::sIDS, 2);
...
int msgProc::sMSMBCrus()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::sIDS, 3);
...
int msgProc::sMSMBShips()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::sIDS, 4);
...
int msgProc::sMSMCShips()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::sIDS, 5);
...
int msgProc::sMSMMShips()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::sIDS, 6);
...
int msgProc::sMSMTitas()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::sIDS, 7);
...
int msgProc::sMSMMBarges()
{
	cout << mRMessage(1) << endl;
	cout << mRMessage(2036) << endl << endl;

	pVRange = getIPair(gv::sIDS, 8);
...
float msgProc::sBISPMenu(float cSpace, float mSpace, float nSpace, Player& mPlayer)
{
	...
	while (!bValid)
	{
		...
		cout << "Cargohold space is sold in 500 sg� increments at 100 Xarn per increment.  Rent for cargohold space, however, is calculated by 1000 sg� increments at 250 Xarn per 1000 sg� of cargohold space used (rounded to highest thousand) up to a max of 1,001,000 sg� per customer." << endl;
...
int msgProc::mMenu1A()
{
	...
	cout << "2) Move the ship" << endl;
	cout << "3) Leave asteroid belt" << endl;
	cout << ">";
	cin >> pChoice;
	cout << endl << endl;
...
int msgProc::mMenu1B()
{
	...
	cout << "4) Done targeting asteroid(s)" << endl;
	cout << "5) Leave asteroid belt" << endl;
	cout << ">";
	cin >> pChoice;
	cout << endl << endl;
...
{
	cout << mRMessage(1) << endl;
	cout << "1) Mine targeted asteroid(s)" << endl;
	cout << "2) Change taget(s)" << endl;
	cout << "3) Leave asteroid belt" << endl;
	cout << ">";
	cin >> pChoice;
	cout << endl << endl;
...
{
	cout << mRMessage(1) << endl;
	cout << "1) Continue mining target(s)" << endl;
	cout << "1) Stop mining target(s)" << endl;
	cout << "2) Change target(s)" << endl;
	cout << "3) Leave astroid belt" << endl;
	cout << ">";
	cin >> pChoice;
	cout << endl << endl;
...
int msgProc::mTMenuA()
{
	...
	cout << "1) Target an Asteroid" << endl;
	cout << "2) Cancel" << endl;
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice, 1, 2, 1, false);
...
int msgProc::mTMenuB()
{
	...
	cout << "1) Target a New Asteroid" << endl;
	cout << "2) Lock another mining laser onto a current target" << endl;
	cout << "3) Cancel" << endl;
	cout << ">";
	cin >> pChoice;
	cout << endl << endl;

	pChoice = checkMInput(pChoice,1,3,1, false);
...
int msgProc::mCTarget(vector<Asteroid> roids, vector<int> scanned, Player& mPlayer, int mTDist)
{
	...
	while (!bValid)
	{
		...
		{
			if ((i == scanned.size()) && (tRoids == 0)) //No asteroids found in range
			{
				cout << mRMessage(2045) << endl;
				return -2;
			}

			else if (i == scanned.size()) //Else if we have gone through the vector and found asteroids
			{
				break; //End the for loop here if asteroids were found that are in range
			}

			else if (i < scanned.size()) //If we have not reached the end of scanned then continue getting distance of current asteroid
			{
			...
			if (tDist <= mTDist) //If asteroid is in range, display it in menu and add one to tRoids
			{
...
void msgProc::sCP5CTMenu(vector<string>& cards)
{
	...
	while (!bValid)
	{
		...
		for (i = 1, i2 = 1; i < cards.size(); i++, i2++)
		{
...
template<typename t> pair<int, int> msgProc::getIPair(vector<vector<t>> vect, int type, int condition)
{
	return make_pair(vect[type].at(condition).vRange.iLow, vect[type].at(condition).vRange.iHigh);
}

template<typename t> pair<int, int> msgProc::getIPair(vector<t> vect, int condition)
{
	return make_pair(vect.at(condition).vRange.iLow,vect.at(condition).vRange.iHigh);
}

void msgProc::pIInfo(pair<int,int> vRange)
{
	for (i1 = vRange.first; i1 <= vRange.second; i1++)
	{
		ds_mp.rData("Weapon_Data", "select from", i1);

		cout << i1 << ") " << ds_mp.getWName() << endl;
	}
}