...
//TODO: Update EQ table calls to adjust for two new fields
...
void Database::returnSResult(vector<ship>& ships)
{
	...
	for (i = 0; i < sResults.size(); i++)
	{
		...
		ships.at(i).sSClass = sResults.at(i).sSClass;
		ships.at(i).sTLevel = sResults.at(i).sTLevel;
		ships.at(i).sCPU = sResults.at(i).sCPU;
		ships.at(i).sRAM = sResults.at(i).sRAM;
		ships.at(i).sPS = sResults.at(i).sPS;
		ships.at(i).sSPS = sResults.at(i).sSPS;
		ships.at(i).sEng = sResults.at(i).sEng;
		ships.at(i).sWFG = sResults.at(i).sWFG;
		ships.at(i).sSM = sResults.at(i).sSM;
		ships.at(i).sAP = sResults.at(i).sAP;
		ships.at(i).sHS = sResults.at(i).sHS;
		ships.at(i).sWTS = sResults.at(i).sWTS;
		ships.at(i).sTSlots = sResults.at(i).sTSlots;
		ships.at(i).lSlots = sResults.at(i).lSlots;
		ships.at(i).mSlots = sResults.at(i).mSlots;
		ships.at(i).hSlots = sResults.at(i).hSlots;
		...
		if (result == SQLITE_ROW)
		{
			...
			if (cols != 0)
			{
				...
				for (i = 0; i <= cols; i++)
				{
					...
					case 7:
						wResults.at(0).wCReq = (float)sqlite3_column_double(statement, i);
						break;

					case 8:
						wResults.at(0).wRReq = (float)sqlite3_column_double(statement, i);
						break;

					case 9:
						wResults.at(0).wACap = sqlite3_column_int(statement, i);
						break;
					...
					case 21:
						wResults.at(0).wIPCon = (float)sqlite3_column_double(statement, i);
						break;
		...
		if (result == SQLITE_ROW)
		{
			...
			if (cols != 0)
			{
				...
				for (i = 0; i <= cols; i++)
				{
					...
					case 2:
						reqResults.at(0).rRID = sqlite3_column_int(statement, i);
						break;
